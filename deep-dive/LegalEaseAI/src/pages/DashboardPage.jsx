      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <Card className="flex flex-col">
          <CardHeader className="flex flex-row items-center justify-between border-b border-border/50 pb-4">
            ...
            <Button variant="ghost" size="sm" className="h-8 group" onClick={() => onNav("cases")}>
          ...
          <CardContent className="p-0 flex-1">
            {loading ? (
              ...
              cases.map((c, i) => (
                <div className={`group flex items-center justify-between p-5 hover:bg-white/[0.02] transition-colors cursor-pointer ${i !== cases.length - 1 ? 'border-b border-border/50' : ''}`} key={c.name} onClick={() => onNav("cases")}>
                  <div>
          ...
          <CardContent className="p-0 py-2 flex-1">
             {loading ? (
              ...
              activity.map((a, i) => {
                ...
                return (
                  <div className="group flex gap-4 p-4 px-5 hover:bg-white/[0.02] transition-colors cursor-pointer" key={i} onClick={() => onNav(a.type === 'alert' ? "upload" : a.type === 'action' ? "upload" : "cases")}>
